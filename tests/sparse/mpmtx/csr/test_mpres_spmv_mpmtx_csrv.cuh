/*
 *  Performance test for the MPRES-BLAS library SpMV routine mp_spmv_mpmtx_csrv (multiple precision matrix)
 *
...
#ifndef TEST_MPRES_SPMV_MPMTX_CSRV_CUH
#define TEST_MPRES_SPMV_MPMTX_CSRV_CUH
...
void test_mpres_spmv_mpmtx_csrv(const int m, const int n, const int nnz, const csr_t &csr, const mpfr_t * x){
    InitCudaTimer();
    Logger::printDash();
    PrintTimerName("[GPU] MPRES-BLAS mp_spmv_mpmtx_csrv");
...
#endif //TEST_MPRES_SPMV_MPMTX_CSRV_CUH