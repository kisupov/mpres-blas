...
#include "sparse/mpmtx/jad/test_mpres_spmv_mpmtx_jad.cuh"
#include "sparse/mpmtx/jad/test_campary_spmv_mpmtx_jad.cuh"
#include "sparse/mpmtx/jad/test_cump_spmv_mpmtx_jad.cuh"
...
void test(const char * MATRIX_PATH, const int M, const int N, const int LINES, const int MAXNZR, const int NNZ, const bool SYMM, const string DATATYPE) {
    ...
    test_mpres_spmv_mpmtx_jad(M, N, MAXNZR, NNZ, JAD.ja, JAD.jcp, JAD.as, JAD.perm, vectorX);
    test_campary_spmv_mpmtx_jad<CAMPARY_PRECISION>(M, N, MAXNZR, NNZ, JAD.ja, JAD.jcp, JAD.as, JAD.perm, vectorX,
                                                   INP_DIGITS);
    test_cump_spmv_mpmtx_jad(M, N, MAXNZR, NNZ, JAD.ja, JAD.jcp, JAD.as, JAD.perm, vectorX, MP_PRECISION, INP_DIGITS);
    checkDeviceHasErrors(cudaDeviceSynchronize());
