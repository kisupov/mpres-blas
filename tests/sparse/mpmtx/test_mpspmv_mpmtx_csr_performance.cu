...
void test(const char * MATRIX_PATH, const int M, const int N, const int LINES, const int NNZ, const bool SYMM, const string DATATYPE) {
    ...
    Logger::printStars();
    test_mpres_mpspmv_mpmtx_csr_vector<2>(M, N, NNZ, CSR, vectorX);
    test_mpres_mpspmv_mpmtx_csr_vector<4>(M, N, NNZ, CSR, vectorX);
    test_mpres_mpspmv_mpmtx_csr_vector<8>(M, N, NNZ, CSR, vectorX);
    test_mpres_mpspmv_mpmtx_csr_vector<16>(M, N, NNZ, CSR, vectorX);
    test_mpres_mpspmv_mpmtx_csr_vector<32>(M, N, NNZ, CSR, vectorX);
    test_mpres_mpspmv_mpmtx_csr_scalar(M, N, NNZ, CSR, vectorX);
    test_mpres_mpspmv_mpmtx_csr_2stage(M, N, NNZ, CSR, vectorX);
    Logger::printStars();
    test_campary_mpspmv_mpmtx_csr_vector<CAMPARY_PRECISION, 2>(M, N, NNZ, CSR, vectorX, INP_DIGITS);
    test_campary_mpspmv_mpmtx_csr_vector<CAMPARY_PRECISION, 4>(M, N, NNZ, CSR, vectorX, INP_DIGITS);
    test_campary_mpspmv_mpmtx_csr_vector<CAMPARY_PRECISION, 8>(M, N, NNZ, CSR, vectorX, INP_DIGITS);
    test_campary_mpspmv_mpmtx_csr_vector<CAMPARY_PRECISION, 16>(M, N, NNZ, CSR, vectorX, INP_DIGITS);
    test_campary_mpspmv_mpmtx_csr_vector<CAMPARY_PRECISION, 32>(M, N, NNZ, CSR, vectorX, INP_DIGITS);
    test_campary_mpspmv_mpmtx_csr_scalar<CAMPARY_PRECISION>(M, N, NNZ, CSR, vectorX, INP_DIGITS);
    Logger::printStars();
