...
#ifndef TEST_CUMP_MPSPMV_MPMTX_JAD_CUH
#define TEST_CUMP_MPSPMV_MPMTX_JAD_CUH
...
void test_cump_mpspmv_mpmtx_jad(const int m, const int n, const int maxnzr, const int nnz, const int *ja, const int *jcp, const double *as, const int *perm_rows, mpfr_t *x, const int prec, const int convert_digits){
    Logger::printDash();
    InitCudaTimer();
...
#endif //TEST_CUMP_MPSPMV_MPMTX_JAD_CUH