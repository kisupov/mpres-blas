...
#ifndef TEST_CAMPARY_MPSPMV_MPMTX_JAD_CUH
#define TEST_CAMPARY_MPSPMV_MPMTX_JAD_CUH
...
template<int prec>
void test_campary_mpspmv_mpmtx_jad(const int m, const int n, const int maxnzr, const int nnz, const int *ja, const int *jcp, const double *as, const int *perm_rows, mpfr_t *x, const int convert_prec) {
    Logger::printDash();
    InitCudaTimer();
...
#endif //TEST_CAMPARY_MPSPMV_MPMTX_JAD_CUH
