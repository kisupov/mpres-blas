/*
 *  Performance test for the MPRES-BLAS library SpMV routine mpspmv_mpmtx_dia (multiple precision matrix)
 *
...
#ifndef TEST_MPRES_MPSPMV_MPMTX_DIA_CUH
#define TEST_MPRES_MPSPMV_MPMTX_DIA_CUH

#include "../../../tsthelper.cuh"
#include "../../../logger.cuh"
#include "../../../timers.cuh"
#include "../../../../src/sparse/mpmtx/mpspmv_mpmtx_dia.cuh"
...
void test_mpres_mpspmv_mpmtx_dia(const int m, const int n, const int ndiag, const int *offset, const double *as, const mpfr_t *x) {
    ...
    //Launch
    StartCudaTimer();
    cuda::mpspmv_mpmtx_dia<<<blocks, threads>>>(m, n, ndiag, doffset, das, dx, dy);
    EndCudaTimer();
    PrintCudaTimer("took");
    checkDeviceHasErrors(cudaDeviceSynchronize());
    cudaCheckErrors();
...
#endif //TEST_MPRES_MPSPMV_MPMTX_DIA_CUH