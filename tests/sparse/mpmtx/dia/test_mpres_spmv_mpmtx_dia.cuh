/*
 *  Performance test for the MPRES-BLAS library SpMV routine mp_spmv_mpmtx_dia (multiple precision matrix)
 *
...
#ifndef TEST_MPRES_SPMV_MPMTX_DIA_CUH
#define TEST_MPRES_SPMV_MPMTX_DIA_CUH

#include "../../../tsthelper.cuh"
#include "../../../logger.cuh"
#include "../../../timers.cuh"
#include "../../../../src/sparse/mpmtx/spmv_mpmtx_dia.cuh"

/////////
//  SpMV DIA scalar kernel
/////////
void test_mpres_spmv_mpmtx_dia(const int m, const int n, const int ndiag, const int *offset, const double *as, const mpfr_t *x) {
    InitCudaTimer();
    Logger::printDash();
    PrintTimerName("[GPU] MPRES-BLAS mp_spmv_mpmtx_dia");
    ...
    //Launch
    StartCudaTimer();
    cuda::mp_spmv_mpmtx_dia<<<blocks, threads>>>(m, n, ndiag, doffset, das, dx, dy);
    EndCudaTimer();
    PrintCudaTimer("took");
    checkDeviceHasErrors(cudaDeviceSynchronize());
    cudaCheckErrors();
...
#endif //TEST_MPRES_SPMV_MPMTX_DIA_CUH