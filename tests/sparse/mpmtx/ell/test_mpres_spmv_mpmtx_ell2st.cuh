/*
 *  Performance test for the MPRES-BLAS library SpMV routine mp_spmv_mpmtx_ell2st (multiple precision matrix)
 *
...
#ifndef TEST_MPRES_SPMV_MPMTX_ELL2ST_CUH
#define TEST_MPRES_SPMV_MPMTX_ELL2ST_CUH
...
/////////
void test_mpres_spmv_mpmtx_ell2st(const int m, const int n, const int maxnzr, const int *ja, const double *as, const mpfr_t *x) {
    Logger::printDash();
    InitCudaTimer();
    PrintTimerName("[GPU] MPRES-BLAS mp_spmv_mpmtx_ell2st");
...
#endif //TEST_MPRES_SPMV_MPMTX_ELL2ST_CUH