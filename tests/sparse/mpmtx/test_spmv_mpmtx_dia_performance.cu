...
#include "sparse/mpmtx/dia/test_mpres_spmv_mpmtx_dia.cuh"
#include "sparse/mpmtx/dia/test_campary_spmv_mpmtx_dia.cuh"
...
void test(const char * MATRIX_PATH, const int M, const int N, const int LINES, const bool SYMM, const string DATATYPE) {
    ...
    test_mpres_spmv_mpmtx_dia(M, N, NDIAG, DIA.offset, DIA.as, vectorX);
    test_campary_spmv_mpmtx_dia<CAMPARY_PRECISION>(M, N, NDIAG, DIA.offset, DIA.as, vectorX, INP_DIGITS);
