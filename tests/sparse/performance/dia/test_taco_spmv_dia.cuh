...
#ifndef TEST_TACO_SPMV_DIA_CUH
#define TEST_TACO_SPMV_DIA_CUH
...
void test_taco_spmv_dia(const char * matrix_path, const mpfr_t * vectorX, const string matrix_type){
    if (matrix_type == "real") {
