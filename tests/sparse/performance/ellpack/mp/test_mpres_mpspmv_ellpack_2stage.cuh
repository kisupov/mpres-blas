/*
 *  Performance test for the MPRES-BLAS library SpMV routine mpspmv_ell_2stage (multiple precision matrix)
 *
...
#ifndef TEST_MPRES_MPSPMV_ELLPACK_2STAGE_CUH
#define TEST_MPRES_MPSPMV_ELLPACK_2STAGE_CUH
...
#include "../../../../../src/sparse/ellpack/mpspmv_ell_2stage.cuh"

/////////
// MPRES-BLAS SpMV two-stage implementation
/////////
void test_mpres_mpspmv_ellpack_2stage(const int m, const int n, const int maxnzr, const int *ja, const double *as,  const mpfr_t *x) {
    Logger::printDash();
    InitCudaTimer();
    ...
    //Launch
    StartCudaTimer();
    cuda::mpspmv_ell_2stage<gridDim1, blockDim1, gridDim2, blockDim3>(m, n, maxnzr, dja, das, dx, dy, dbuf);
    EndCudaTimer();
    PrintCudaTimer("took");
    checkDeviceHasErrors(cudaDeviceSynchronize());
    cudaCheckErrors();
...
#endif //TEST_MPRES_MPSPMV_ELLPACK_2STAGE_CUH