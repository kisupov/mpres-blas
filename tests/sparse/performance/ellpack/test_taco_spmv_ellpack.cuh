...
#ifndef TEST_TACO_SPMV_ELLPACK_CUH
#define TEST_TACO_SPMV_ELLPACK_CUH
...
void test_taco_spmv_ellpack(const char * matrix_path, const mpfr_t * vectorX, const string matrix_type){
    if (matrix_type == "real") {
        using namespace taco;
        InitCpuTimer();
        Logger::printDash();
        PrintTimerName("[CPU] TACO SpMV ELLPACK");
...
#endif //TEST_TACO_SPMV_ELLPACK_CUH
