...
#include "logger.cuh"
#include "timers.cuh"
#include "sparse/ellpack/mpspmv_ell_scalar.cuh"

/////////
//  SpMV ELLPACK scalar kernel
/////////
void test_mpres_mpspmv_ellpack_scalar(const int m, const int n, const int nzr, const int *ja, const double *as, const mpfr_t *x){
    InitCudaTimer();
    Logger::printDash();
