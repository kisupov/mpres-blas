...
template<int prec>
void test_campary_mpdspmv_jad(const int m, const int n, const int maxnzr, const int nnz, const int *ja, const int *jcp, const double *as, const int *perm_rows, mpfr_t *x, const int convert_prec) {
    Logger::printDash();
    InitCudaTimer();
