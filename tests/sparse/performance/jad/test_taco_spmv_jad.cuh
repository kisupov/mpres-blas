...
#ifndef TEST_TACO_SPMV_JAD_CUH
#define TEST_TACO_SPMV_JAD_CUH
...
void test_taco_spmv_jad(const char * matrix_path, const mpfr_t * vectorX, const string matrix_type){
    if (matrix_type == "real") {
        using namespace taco;
        InitCpuTimer();
        Logger::printDash();
        PrintTimerName("[CPU] TACO SpMV JAD");
