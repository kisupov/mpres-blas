...
#ifndef TEST_CAMPARY_MPDSPMV_CSR_VECTOR_CUH
#define TEST_CAMPARY_MPDSPMV_CSR_VECTOR_CUH
...
template<int prec, int threadsPerRow>
void test_campary_mpdspmv_csr_vector(const int m, const int n, const int nnz, const int *irp, const int *ja, const double *as,  mpfr_t *x, const int convert_prec) {
    Logger::printDash();
    InitCudaTimer();
...
#endif //TEST_CAMPARY_MPDSPMV_CSR_VECTOR_CUH
