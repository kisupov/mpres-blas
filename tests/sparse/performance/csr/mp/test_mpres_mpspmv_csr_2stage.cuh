/*
 *  Performance test for the MPRES-BLAS library SpMV routine mpspmv_csr_2stage (multiple precision matrix)
 *
...
#ifndef TEST_MPRES_MPSPMV_CSR_2STAGE_CUH
#define TEST_MPRES_MPSPMV_CSR_2STAGE_CUH
...
#include "../../../../../src/sparse/csr/mpspmv_csr_2stage.cuh"

/////////
// SpMV CSR two-stage implementation
/////////
void test_mpres_mpspmv_csr_2stage(const int m, const int n, const int nnz, const int *irp, const int *ja, const double *as,  const mpfr_t * x){
    Logger::printDash();
    InitCudaTimer();
...
#endif //TEST_MPRES_MPSPMV_CSR_2STAGE_CUH