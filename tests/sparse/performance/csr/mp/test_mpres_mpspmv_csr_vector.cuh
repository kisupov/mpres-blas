/*
 *  Performance test for the MPRES-BLAS library SpMV routine mpspmv_csr_vector (multiple precision matrix)
 *
...
#include "../../../../logger.cuh"
#include "../../../../timers.cuh"
#include "../../../../../src/sparse/csr/mpspmv_csr_vector.cuh"
...
void test_mpres_mpspmv_csr_vector(const int m, const int n, const int nnz, const int *irp, const int *ja, const double *as,  const mpfr_t * x){
    InitCudaTimer();
    Logger::printDash();
    PrintTimerName("[GPU] MPRES-BLAS mpspmv_csr_vector");
