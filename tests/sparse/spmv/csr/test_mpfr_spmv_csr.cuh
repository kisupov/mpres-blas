/*
 *  Performance test for SpMV CSR routine using MPFR (double precision matrix)
 *
...
/////////
void mpfr_mpspmv_csr(const int m, const int *irp, const int *ja, const double *as, const mpfr_t *x, mpfr_t *y, const int prec) {
...
void test_mpfr_spmv_csr(const int m, const int n, const int nnz, const csr_t &csr, const mpfr_t *x, const int prec) {
    InitCpuTimer();
    Logger::printDash();
