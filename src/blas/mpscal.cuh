...
namespace cuda {
     ...
     *
     * @warning If incx is not equal to 1, then BLOCK_SIZE_FOR_RESIDUES must be equal to RNS_MODULI_SIZE
     */
    ...
    void mp_array_scal(int n, mp_array_t &alpha, mp_array_t &x, int incx) {
        ...
        mp_array_mul_digits_vs<<< gridDim2, BLOCK_SIZE_FOR_RESIDUES >>> (x, incx, x, incx, alpha, n);
