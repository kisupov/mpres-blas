...
namespace cuda {
    ...
    void mp_array_rot(int n, mp_array_t &x, int incx, mp_array_t &y, int incy, mp_array_t &c, mp_array_t &s, mp_array_t &buffer1, mp_array_t &buffer2) {
        ...
        cuda::mp_array_mul_digits_vs<<< gridDim2, BLOCK_SIZE_FOR_RESIDUES >>> (buffer1, 1, x, incx, s, n);
        ...
        cuda::mp_array_mul_digits_vs<<< gridDim2, BLOCK_SIZE_FOR_RESIDUES >>> (buffer2, 1, y, incy, s, n);
        ...
        mp_array_add_digits_vv<<< gridDim2, BLOCK_SIZE_FOR_RESIDUES >>> (x, incx, x, incx, buffer2, 1, n);
        ...
        mp_array_add_digits_vv<<< gridDim2, BLOCK_SIZE_FOR_RESIDUES >>> (y, incy, y, incy, buffer1, 1, n);
