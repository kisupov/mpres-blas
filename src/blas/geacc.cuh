...
#ifndef MPRES_GEACC_CUH
#define MPRES_GEACC_CUH
...
namespace cuda
{
    ...
    void mp_ge_acc(const int m, const int n, mp_array_t &alpha, mp_array_t &A, const int lda,  mp_array_t &beta, mp_array_t &B, const int ldb, mp_array_t &buffer){
