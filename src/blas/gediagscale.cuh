...
#ifndef MPRES_GEDIAGSCALE_CUH
#define MPRES_GEDIAGSCALE_CUH
...
namespace cuda
{
    ...
    void mp_ge_diag_scale(enum mblas_side_type side, const int m, const int n, mp_array_t &D, const int incd,  mp_array_t &A, const int lda){
