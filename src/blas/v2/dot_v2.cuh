...
namespace cuda {
     ...
     * For final reduction, mp_dot_kernel2 should be used
     */
    ...
    void mp_dot(const int n, mp_float_ptr x, mp_float_ptr y, mp_float_ptr r) {
        ...
        mp_dot_kernel1 <threads><<< blocks, threads >>> (n, POW, x, y, dbuf);
        mp_dot_kernel2 <threads><<< 1, threads >>> (blocks, POW, dbuf, r);
        cudaFree(dbuf);
    }
