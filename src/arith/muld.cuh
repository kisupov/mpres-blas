...
#ifndef MPRES_MULD_CUH
#define MPRES_MULD_CUH
 ...
 * result = x * y
 */
GCC_FORCEINLINE void mp_mul_d(mp_float_ptr result, mp_float_t x, const double y) {
...
namespace cuda {
     ...
     * result = x * y
     */
    DEVICE_CUDA_FORCEINLINE void mp_mul_d(mp_float_ptr result, const mp_float_t x, const double y) {
