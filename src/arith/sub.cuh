 ...
 * result = x - y
 */
GCC_FORCEINLINE void mp_sub(mp_float_ptr result, mp_float_ptr x, mp_float_ptr y) {
...
namespace cuda {
     ...
     * result = x - y
     */
    DEVICE_CUDA_FORCEINLINE void mp_sub(mp_float_ptr result, mp_float_ptr x, mp_float_ptr y) {
