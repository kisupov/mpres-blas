...
#define RNS_EVAL_MIN_LIMIT 4.6043169277254492e-05

#define RNS_EVAL_OFFSET_VEC_SIZE 174

const int RNS_MODULI[] = {
        32611,32613,32615,32617,32621,32623,32629,32633,32639,32647,32651,32653,32663,32671,32677,32687,
