 ...
 *  214-bit dynamic range of the RNS
 *  106 bits of precision (2-double)
 *
...
#define RNS_MODULI_PRODUCT_LOG2 (214)
...
#define RNS_EVAL_OFFSET_VEC_SIZE (10)

const int RNS_MODULI[] = {113812103,113812105,113812107,113812109,113812111,113812117,113812121,113812123};
