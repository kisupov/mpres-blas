/*
 *  Preconditioned multiple precision CG iterative method for solving linear systems using the CSR matrix storage format
...
#ifndef MPRES_PCG_CSR_CUH
#define MPRES_PCG_CSR_CUH
