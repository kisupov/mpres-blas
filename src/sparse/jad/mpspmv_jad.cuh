...
namespace cuda {
     ...
     */
    __global__ void mpspmv_jad(const int m, const int maxnzr, const mp_float_ptr as, const int *ja, const int *jcp, const int *perm_rows, mp_float_ptr x, mp_float_ptr y) {
