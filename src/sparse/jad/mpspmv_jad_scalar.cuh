...
namespace cuda {
     ...
     *
     * @note The matrix is represented in multiply precision
     ...
     */
    __global__ void mpspmv_jad_scalar(const int m, const_int maxnzr, const mp_float_ptr *as, const int *ja, const int *jcp, const int *perm_rows, mp_float_ptr x, mp_float_ptr y) {
