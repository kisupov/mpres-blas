...
namespace cuda {
     ...
     */
    __global__ void mpdspmv_jad_scalar(const int m, const_int maxnzr, const double *as, const int *ja, const int *jcp, const int *perm_rows, mp_float_ptr x, mp_float_ptr y) {
