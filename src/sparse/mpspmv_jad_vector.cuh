...
#ifndef MPSPMV_JAD_VECTOR_CUH
#define MPSPMV_JAD_VECTOR_CUH
...
namespace cuda {
    ...
    __global__ void mpspmv_jad_vector(const int m, const int maxnzr, const jad_t jad, mp_float_ptr x, mp_float_ptr y) {
