...
#ifndef MPRES_SPMV_ELL_CUH
#define MPRES_SPMV_ELL_CUH
...
namespace cuda {
    ...
    __global__ void mp_spmv_ell(const int m, const int maxnzr, const ell_t ell, mp_float_ptr x, mp_float_ptr y) {
